...
/**
 * La classe `Projectile1Controller` est un contrôleur spécifique pour gérer le comportement d'un projectile de type 1.
 * Elle hérite de la classe `Controller` et permet de gérer l'affichage et la mise à jour de la position du projectile.
 */
public class Projectile1Controller extends Controller {
     ...
     */
    public Projectile1Controller(Entity entity, EntityManager entityManager) {
