...
/**
 * La classe `Projectile3Controller` est un contrôleur spécifique pour gérer le comportement d'un projectile de type 3.
 * Elle hérite de la classe `Controller` et permet de gérer l'affichage et la mise à jour de la position du projectile.
 */
public class Projectile3Controller extends Controller {

    /**
     * Constructeur de la classe `Projectile3Controller`.
     ...
     */
    public Projectile3Controller(Entity entity, EntityManager entityManager) {
