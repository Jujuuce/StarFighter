...
/**
 * Le contrôleur `EnemyType1Controller` gère le comportement d'un ennemi de type 1 dans le jeu.
 * Il hérite de la classe `Controller` et définit la logique de déplacement et d'attaque de l'ennemi.
 */
public class EnemyType1Controller extends Controller {
     ...
     */
    public EnemyType1Controller(Entity entity, EntityManager entityManager) {
        super(entity, entityManager);
        setVelocity(new Vector2(0, -1));  // Définit la vitesse de l'ennemi.
        setProjectileStrategy(new Projectile1Strategy());  // Définit la stratégie de projectile pour l'ennemi.
    }
