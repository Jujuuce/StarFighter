...
/**
 * Représente un type de boss (BossType2) dans le jeu, dérivé de la classe `Enemy`.
 * Ce boss utilise une texture spécifique et possède les comportements d'un ennemi, mais avec des caractéristiques uniques.
 */
public class BossType2 extends Enemy {

    /**
     * Constructeur d'un BossType2.
     ...
     */
    public BossType2(float X, float Y, int health, SpriteBatch batch) {
        super(X, Y, health, batch, "Skins/ufoGreen.png");
    }
}
